...
1) Play/ pause cycles the presets 1 to 4, please change for your own use e.g. '{"ps":"1~5~r"}' '{"ps":"1~9~r"}'


2) If you want to have different values for brightness or other single or double clicks, you need to get the hex integer(s) (there are often multiple for a single or double click).

An example is here, double click is +30 and single click is +10 (brightness, but can be any other value)
```
